...
<div class="card">
    <table class="tableshowtexto">
        <tr>
                <a href="{{ route('series.seasons.show', ['serie' => $serie, 'season' => $season]) }}" class="text h2 fw-bold">{{ $serie->title }}</a>
            <h1 class="text h4 fw-bold">{{ $episode->title }}</strong></h1>
        </tr>
        </tbody>
    </table>
    <table>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8 ">
            <div class="card ">
                <h2 class="linea-inferior text-center fw-bold">Write your Review</h2>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <h2 class="linea-inferior text-center fw-bold">Reviews</h2>
                @if(count($comments) > 0)
